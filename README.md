...
# Bug 1: Select dropdown doesn't scroll with rest of the page [x]
...
# Bug 2: Approve checkbox not working [x]
...
# Bug 3: Cannot select _All Employees_ after selecting an employee [x]
...
# Bug 5: Employees filter not available during loading more data [x]
...
# Bug 6: View more button not working as expected [x]
